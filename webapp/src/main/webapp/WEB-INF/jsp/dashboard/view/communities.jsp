		...
		<div class="row">
						...
						<div class="card p-3 m-3 shadow-sm--hover ">
							<div class="row">
								<div class="d-flex flex-column justify-content-start ml-3">
									<div class="h2 text-primary"><c:out value="Nombre de la comunidad"/></div>
								</div>
								<div class="col-12 text-wrap-ellipsis">
									<p class="h5"><c:out value="Descripcion"/></p>
								</div>
							</div>
						</div>
			...
			<div class="col-3">
				<div class="white-pill mt-5 mr-3">
					<div class="card-body">
						<p class="h3 text-primary text-center">CREAR COMUNIDAD</p>
						<hr>
						<p class="h5 my-3">Creá tu propia comunidad para juntar y gestionar todas las preguntas especificas sobre tu tema.</p>
