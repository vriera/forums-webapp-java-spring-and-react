        ...
        http.sessionManagement()
                ...
                .and()
                    .authorizeRequests()
                        ...
                        .antMatchers("/api/questions/{id}/votes/users/{idUser}").hasAuthority("USER")
                        .antMatchers("/api/questions/{id}/verify/").hasAuthority("USER")
                        .antMatchers("/api/answers/{id}/verify/").hasAuthority("USER")
                        .antMatchers("/api/answers/{id}/votes/users/{idUser}").hasAuthority("USER")
