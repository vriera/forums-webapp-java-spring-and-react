        ...
        http.sessionManagement()
                ...
                .and()
                    .authorizeRequests()
                        ...
                        .antMatchers("/api/questions/{id}/votes/users/{idUser}").hasAnyRole("USER", "MODERATOR")
                        .antMatchers("/api/questions/{id}/verify/").hasAnyRole("USER", "MODERATOR")
                        .antMatchers("/api/answers/{id}/verify/").hasAnyRole("USER", "MODERATOR")
                        .antMatchers("/api/answers/{id}/votes/users/{idUser}").hasAnyRole("USER", "MODERATOR")
                        .antMatchers(HttpMethod.POST,"/api/**").hasAnyRole("USER", "MODERATOR")
                        .antMatchers(HttpMethod.PUT,"/api/**").hasAnyRole("USER", "MODERATOR")
                        .antMatchers(HttpMethod.DELETE,"/api/**").hasAnyRole("USER", "MODERATOR") //TODO: SE PUEDEN HACER MENSAJES DE ERROR CUSTOMS?
                        .antMatchers("/api/community/create").hasAnyRole("USER", "MODERATOR")
                        .antMatchers("/api/dashboard/community/{communityId}/view/*").hasRole("MODERATOR")
                        .antMatchers("/api/dashboard/**").hasAnyRole("USER", "MODERATOR")
