...
const UserCommunitiesPane = () => {
    ...
    const [moderatedCommunities, setModeratedCommunities] = useState<CommunityCard[]>(undefined as unknown as CommunityCard[]);
    ...
    useEffect(() => {
        ...
        history.push({ pathname: `${process.env.PUBLIC_URL}/user/${userId}/communities?page=${pageFromQuery}`})
    ...
    return (
        <div className="white-pill mt-5">
            <div className="card-body overflow-hidden">
                ...
                {moderatedCommunities && moderatedCommunities.length > 0 && moderatedCommunities.map((community) => (
