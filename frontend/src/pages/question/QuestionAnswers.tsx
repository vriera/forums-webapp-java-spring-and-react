...
const AnswerPage = (props: { user: User }) => {
  ...
  useEffect(() => {
    async function loadQuestion() {
      try {
        if (!questionId) {
          // Verificar si questionId es undefined
          throw new InternalServerError(
            "Tried to fetch question with undefined id"
          );
        }
      ...
      <div className="row">
        ...
        <div className="col-6">
          <QuestionUserContext.Provider
            value={{ questionUser, setQuestionUser }}
          >
            <QuestionAnswersCenterPanel
              user={props.user}
