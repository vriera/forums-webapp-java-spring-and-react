...
const RequestedCommunitiesPane = (props: {user: User}) => {
    ...
    return (
        <div className="white-pill mt-5">
            <div className="card-body">
                ...
                <DashboardAccessTabs notifications={notifications /* FIXME */ } activeTab="requested"/>
...
const RequestedCommunitiesPage = (props: {user: User}) => {
            ...
            <div className="wrapper">
                <div className="section section-hero section-shaped pt-3">
                    ...
                    <div className="row">
                        ...
                        {/* CENTER PANE*/}
                        <div className="col-6">
                            <RequestedCommunitiesPane user={auxUser}/>
