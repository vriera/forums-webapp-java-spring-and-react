      ...
      <>
        ...
        <div className="overflow-auto">
            ...
            props.params.userList.map((user: User) =>
              <>
              <ModalPage buttonName={t("dashboard.UnbanUser")} show={showModalForUnban} onClose={handleCloseModalForUnban} onConfirm={() => handleUnban(user.id)}/>

              <BannedCard user={user} key={user.id} unbanUserCallback={handleShowModalForUnban}/>
              </>
            )
            }
