    ...
    return (
        <>
            ...
            {props.category == "access" &&
                <p className="h3 text-primary">{t("dashboard.access")}</p>
            }
    ...
    return(
        <>
            <div className="section section-hero section-shaped">
                <Background/>
                <CommunityInformationPane communityName="Chocolatería" communityDescription="Descripcion!"/>
                <div className="row">
                    <div className="col-3">
                        < CommunitiesCard title={t("dashboard.Modcommunities")} communities={communities} thisCommunity={"matematica"}/>
                    </div>  
