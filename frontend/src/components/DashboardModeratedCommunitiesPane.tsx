...
const ModeratedCommunitiesPane = (props: {communities: CommunityCard[], selectedCommunity: CommunityCard, setSelectedCommunityCallback: (community: CommunityCard) => void , currentPage: number, totalPages: number, setCurrentPageCallback: (page: number) => void}) => {
    ...
    return (
        <div className="white-pill mt-5 mx-3">
            <div className="card-body">
                ...
                <div className="container-fluid">
                    ...
                    props.communities.map((community) => (
                        <CommunityModerationButton community={community}
                                                   setSelectedCommunityCallback={props.setSelectedCommunityCallback}
                    ...
                    ))}
                    {
                        ...
                        <div>
                            ...
                            <div className="d-flex justify-content-center">
                                <img className="row w-25 h-25" src={require('../images/empty.png')}
                                     alt="Nothing to show"/>
                            </div>
                        </div>
                    }
            ...
            <Pagination currentPage={props.currentPage} setCurrentPageCallback={props.setCurrentPageCallback}
