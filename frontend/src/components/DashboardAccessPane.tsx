...
const Tabs = (props: {
  ...
  option: string;
  setOptionCallback: (
    option: "admitted" | "invites" | "requests" | "rejections"
  ) => void;
}) => {
  const { t } = useTranslation();
    ...
    <div>
      <ul className="nav nav-tabs">
        <li className="nav-item">
          <button
            className={"nav-link " + (props.option === "admitted" && "active")}
            onClick={() => props.setOptionCallback("admitted")}
          >
        ...
        <li className="nav-item">
          <button
            className={"nav-link " + (props.option === "invites" && "active")}
            onClick={() => props.setOptionCallback("invites")}
          >
            {t("dashboard.invites")}
            {props.notifications.invites > 0 && (
              <span className="badge badge-secondary bg-warning text-white ml-1">
                {props.notifications.invites}
              </span>
            )}
          </button>
        </li>
        ...
        <li className="nav-item">
          <button
            className={"nav-link " + (props.option === "requests" && "active")}
            onClick={() => props.setOptionCallback("requests")}
          >
            {t("dashboard.requests")}
            {props.notifications.requests > 0 && (
              <span className="badge badge-secondary bg-warning text-white ml-1">
                {props.notifications.requests}
              </span>
            )}
          </button>
        </li>
        ...
        <li className="nav-item">
          <button
            className={"nav-link " + (props.option === "rejected" && "active")}
            onClick={() => props.setOptionCallback("rejections")}
          >
...
const AdmittedCommunities = (props: { communities: Community[] }) => {
  ...
  return (
    <div>
      ...
      <ModalPage
        buttonName="Hola"
        show={showModalForAdmitted}
        onClose={handleCloseModalForAdmitted}
      />
                  ...
                  <div className="row">
                    ...
                    <div className="col-auto px-0">
                      <button
                        ...
                        onClick={handleShowModalForAdmitted}
                      >
...
const ManageInvites = (props: {
  ...
  return (
    <div>
      <ModalPage
        buttonName="Hola"
        show={showModalForInvites}
        onClose={handleCloseModalForInvites}
      />
                ...
                <div className="row">
                  <div className="col-auto mx-0 px-0">
                    ...
                    <button
                      className="btn mb-0"
                      onClick={
                        /* () => acceptInvite(community); */ handleShowModalForInvites
                      }
                  ...
                  <div className="col-auto mx-0 px-0">
                    ...
                    <button
                      className="btn mb-0"
                      onClick={
                        /* () => rejectInvite(community) */ handleShowModalForInvites
                      }
                  ...
                  <div className="col-auto mx-0 px-0">
                    ...
                    <button
                      className="btn mb-0"
                      onClick={
                        /* () => blockCommunity(community) */ handleShowModalForInvites
                      }
                      title={t("dashboard.BlockCommunity")}
                    >
                      <div className="h4 mb-0">
...
const ManageRequests = (props: {
  ...
  return (
    <div className="">
      <ModalPage
        buttonName="Hola"
        show={showModalForRequests}
        onClose={handleCloseModalForRequests}
      />
          ...
          <div className="card" key={community.id}>
            ...
            >
              ...
              <button
                className="btn mb-0"
                onClick={
                  /* () => requestAccess(community) */ handleShowModalForRequests
                }
...
const ManageRejections = (props: {
  ...
  return (
    <div>
      <ModalPage
        buttonName="Hola"
        show={showModalForRejections}
        onClose={handleCloseModalForRejections}
      />
      <div className="">
        <div className="overflow-auto">
            ...
            <div className="card" key={community.id}>
              ...
              >
                ...
                <button
                  className="btn mb-0"
                  onClick={
                    /* () => requestAccess(community) */ handleShowModalForRejections
                  }
                  title={t("dashboard.ResendRequest")}
                >
                  <div className="h4 mb-0">
        ...
        return (
          <div className="white-pill mt-5">
            <div className="card-body">
              ...
              />
              <ManageInvites
                invited={communities /*TODO: PEDIDO A LA API*/}
                totalPages={5 /* TODO: PEDIDO A LA API */}
                user={props.user}
              />
            </div>
          </div>
        ...
        return (
          <div className="white-pill mt-5">
            <div className="card-body">
              ...
              />
              <ManageRequests
                requested={communities /*TODO: PEDIDO A LA API*/}
                totalPages={5 /* TODO: PEDIDO A LA API */}
              />
            </div>
          </div>
        ...
        return (
          <div className="white-pill mt-5">
            <div className="card-body">
              ...
              />
              <ManageRejections
                rejected={communities /*TODO: PEDIDO A LA API*/}
                totalPages={5 /* TODO: PEDIDO A LA API */}
                user={props.user}
              />
            </div>
