...
import { UserUpdateParams, getKarmaFromApi, getUser, getUserFromApi, updateUser } from "../services/user";
...
const UpdateProfilePage = (props: {user: User}) => {
    ...
    return (
        <div className="white-pill mt-5">
            <ModalPage buttonName={t("profile.save")} show={showModal} onClose={handleCloseModal} onConfirm={handleBlock}/>
            ...
            <div className="card-body overflow-hidden">
                ...
                <div>                    
                    <div className="text-center">
                        <img className="rounded-circle" src={"https://avatars.dicebear.com/api/avataaars/"+ user.email+".svg"} alt="User profile icon" style={{height: "80px", width: "80px"}}/>
                    ...
                    <div>
                        ...
                        <div className="mb-3 text-center">
                            <input type="password" className="form-control" placeholder={t("profile.optional")}onChange={(e) => setNewPassword(e.target.value)}/>
                        </div>
                        ...
                        <div className="text-center">
                            <Link to="/dashboard/profile/info" className="btn btn-secondary text-center">{t("cancel")}</Link>
                            <button onClick={handleShowModal} className="btn btn-primary text-center">{t("profile.update")}</button>
                        </div>
                    </div>
                </div>
                }
